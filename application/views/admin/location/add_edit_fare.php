					...
					?>
						...
						<button type="submit" style="display:none;" id="btn_<?php echo $row->_id; ?>"></button>
	 						<ul>
								...
								<li>
									<h4><?php if ($this->lang->line('admin_location_and_fare_waiting_charges') != '') echo stripslashes($this->lang->line('admin_location_and_fare_waiting_charges')); else echo 'Extra charges'; ?></h4>
								</li>
                                <li>
									<div class="form_grid_12">
