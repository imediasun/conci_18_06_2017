			...
			<div class="widget_wrap">
				...
				<div class="widget_content">
					...
					<div id="tab2">
						...
						<?php }else{ ?>
							<?php if ($this->lang->line('admin_location_and_fare_informations_are_not_availble') != '') echo stripslashes($this->lang->line('admin_location_and_fare_informations_are_not_availble')); else echo 'informations are not availble'; ?>
						<?php } ?>
					</div>
					<div id="tab3">
						<?php #echo $map['js']; ?>
