				...
				<div class="widget_wrap">
					...
					?>
	 						<ul>
								...
								<div class="form_grid_12">
									<label class="field_title"><?php if ($this->lang->line('admin_subadmin_mangement_name') != '') echo stripslashes($this->lang->line('admin_subadmin_mangement_name')); else echo 'Mangement Name'; ?></label>
