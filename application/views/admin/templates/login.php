...
<?php } ?>
		...
		<?php echo form_open('admin/adminlogin/admin_login');  ?>
			...
			<ul class="login_opt_link" style="float:left">
				<li style=" margin: 6px 0 0;"><a href="admin/adminlogin/admin_forgot_password_form" class="tipLeft" title="Click to reset a new password"><?php if ($this->lang->line('admin_login_forgot_password') != '') echo stripslashes($this->lang->line('admin_login_forgot_password')); else echo 'Forgot Password'; ?>?</a></li>
