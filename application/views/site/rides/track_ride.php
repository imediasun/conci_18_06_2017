...
<script>
	...
	var weblink = "<?php echo current_url().'?q='.$ride_details->ride_id; ?>";
	...
	if (iOS){
		...
		var appUrlScheme = "CabilyDectar://ride_id/<?php echo $ride_details->ride_id; ?>";
	...
	if (aNDROID){
		...
		var appUrlScheme = "com.casperon.app.cabily://ride_id/<?php echo $ride_details->ride_id; ?>";
		//If the app is not installed the script will wait for 2sec and redirect to web.
		var loadedAt = +new Date;
		setTimeout(
			function(){
