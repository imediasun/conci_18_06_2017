                ...
                <div class="col-lg-7 sign_up2_center edit-rider">
                    ...
                    <div class="sign_up_acc col-md-12 edit-details">
						...
						<div class="col-lg-12 sign_up_base">
                            ...
                            <input name="user_name" id="user_name" type="text" class="form-control required" placeholder="User Name" value="<?php echo $rider_info->row()->user_name; ?>">
                        </div>
                        <div class="col-lg-12 sign_up_base">
...
<!--                                    <input type="file" class="media_image" name="fileToUpload" size="40" class="img-upload">-->
                        ...
                        <div class="col-lg-12 sign_up_base">
                            <label><?php if ($this->lang->line('rider_profile_mobile_number') != '') echo stripslashes($this->lang->line('rider_profile_mobile_number')); else echo 'Mobile Number'; ?><span id="cancel_otp" style="display: none;cursor: pointer"><?php if ($this->lang->line('rider_profile_cancel') != '') echo stripslashes($this->lang->line('rider_profile_cancel')); else echo 'Cancel'; ?></span>
                            ...
                            <div id='change_mobile_number' style="display: none">
                                ...
                                <div class="col-lg-7 nopadd" style="margin-left:5px">
                                    <input name="mNumber" type="text" class=" required form-control mNumber" placeholder="(201) 555-5555" value="<?php echo $rider_info->row()->phone_number; ?>">
                                </div>
                                <div class="col-lg-2 nopadd" style="margin-left:5px; margin-top: 13px">
								 ...
								 <div class="col-lg-12 sign_up_base enter_otp" style="display: none" id='otpblock'>
                                    ...
                                    <div class="col-lg-6 nopadd" style="margin-left:5px">
